 ...
 */
void BcUpdate::UpdatePiece(const int s, const int p, const int start, const int dest) {
 ...
 */
void BcUpdate::RemovePiece(const int s, const int p, const int sq) {
	AddKey(s, p, sq);
	board[sq] = EMPTY;
 ...
 */
void BcUpdate::AddPiece(const int s, const int p, const int sq) {
	board[sq] = p;
	AddKey(s, p, sq);
	bit_units[s] |= mask[sq];
 ...
 */
int BcUpdate::MakeMove(const int start, const int dest) {
 ...
 */
int BcUpdate::MakeRecapture(const int from, const int to) {
 ...
 */
void BcUpdate::UnMakeRecapture() {
	side ^= 1;
	xside ^= 1;
	--ply;
	--hply;

	UpdatePiece(side, board[game_list[hply].dest], game_list[hply].dest,
			game_list[hply].start);
